...
import com.medunnes.telemedicine.databinding.FaskesListBinding

class FaskesAdapter(private val faskesList: ArrayList<Faskes>) : RecyclerView.Adapter<FaskesAdapter.ListViewHolder>() {
    class ListViewHolder(private val binding: FaskesListBinding) : RecyclerView.ViewHolder(binding.root) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ListViewHolder {
        val binding = FaskesListBinding.inflate(LayoutInflater.from(parent.context), parent, false)
